...
import { ReportConfig, ChartData, SalesData, GSTReport } from '../types';
...
// Use safeFormatCurrency and safeLocaleString from inside the component, which depend on currency state

const REPORT_TYPES = [
  { id: 'inventory', name: 'Inventory Report', icon: '📊', description: 'Stock levels, valuation, and movement' },
  { id: 'sales', name: 'Sales Report', icon: '📈', description: 'Revenue, transactions, and trends' },
  { id: 'financial', name: 'Financial Report', icon: '🥧', description: 'P&L, cash flow, and margins' },
  { id: 'gst', name: 'GST Report', icon: '📄', description: 'Tax compliance and filings' },
  { id: 'custom', name: 'Custom Report', icon: '⚙️', description: 'Build your own report' },
];

const CHART_COLORS = ['#6366f1', '#8b5cf6', '#ec4899', '#f59e0b', '#10b981', '#f97316'];
...
const Reports: React.FC = () => {
  ...
  // Auto-generate report when filters change (with debounce)
  useEffect(() => {
  ...
  }, [selectedReportType, dateRange, generateReport]);
  ...
  // Helper function to render report header with key metrics
  ...
  // Helper function to render main report content
  ...
  return (
    <div className="page-container" style={{ 
      ...
      <div style={{ 
        ...
        <div 
          className={`${reportData ? 'bounce-in' : ''}`} 
          key={`report-content-${animationKey}`}
          style={{ 
            display: 'flex', 
